...
export function TextInput({ error, className = "", ...props }: TextInputProps) {
  const baseClasses = "block w-full rounded-lg border-0 px-3 py-2.5 text-gray-900 ring-1 ring-inset placeholder:text-gray-400 focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6 transition-colors";
